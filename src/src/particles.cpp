...
void ParticleFx::initWithSpellMoveEffect( SpellId num )
{
	switch( num ) {
		...
		default:
			effect[0]=-1;   effect[1]=-1;   effect[2]=-1;   effect[3]=-1;   effect[4]=-1;
			break;
	}
}
...
void ParticleFx::initWithSpellStatEffect( SpellId num )
{
	...
	switch( num+1 )
	{
		...
		case 4:
			te0=0x37; te1=0x6A; te2=0x09; te3=0x06; 
			te4=0x37; te5=0x6A; te6=0x09; te7=0x20;
			te8=0x13; te9=0x8d; te10=0xffffff00;
			break;
    
		case 7:
			te0=0x37; te1=0x3A; te2=0x00; te3=15;
			te4=0x37; te5=0x6A; te6=0x09; te7=0x20;
		...
		case 12:
			te0=0x37; te1=0x4A; te2=0x09; te3=0x07; 
		...
		case 22:
			te0=0x37; te1=0x2A; te2=0x09; te3=0x06; 
		...
		case 26:
			te0=0x37; te1=0x5A; te2=0x09; te3=0x06; 
			te4=0x37; te5=0x5a; te6=0x09; te7=0x14;
		...
		case 38:
			te0=0x37; te1=0x35; te2=0x00; te3=30;
		...
		case 43:
			te0=0x36; te1=0xB0; te2=0x09; te3=0x09; 
		...
		case 51:
			te0=0x37; te1=0x09; te2=0x09; te3=0x19;
		...
		case 99:
			te0=0x37; te1=0x35; te2=0x00; te3=0x30;  // fizzle
			te4=0x00; te5=0x00; te6=0x0a; te7=0x0f;
			te8=0x0f; te9=0xcb; te10=0xffffff01;    
			break;           

		default:
			te0=-1; te1=-1; te2=-1; te3=-1;
			break;
	}
